...
comps=dead_code,sequences,unsafe,drop_debugger,conditionals,comparisons,evaluate,booleans,loops,unused,join_vars,drop_console,properties,drop_debugger,cascade,keep_fargs=false,keep_fnames=false
